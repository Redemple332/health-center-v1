...
@section('title', 'Inventory Management - Medicine List')
        ...
        <div class="table-responsive text-nowrap">
            <table class="table table-striped table-hover">
                ...
                <tbody id="table-content" class="table-border-bottom-0">
                    @include('content.inventory-management.medicine-list.table')
                </tbody>
            </table>
        </div>
    </div>
    <!--/ Striped Rows -->
    @include('content.inventory-management.medicine-list.form')
